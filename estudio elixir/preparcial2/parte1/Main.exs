defmodule Main do
  def main do
    ...
    lista3=[ 5, 2, 8]
    Util.mostrar_mensaje("suma lista: #{inspect(Util.sumar_lista(lista3), charlists: :as_lists)}")
    ...
    Util.mostrar_mensaje("el min max de la lista son #{inspect(Util.min_max(lista2))}")
